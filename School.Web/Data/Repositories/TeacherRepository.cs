...
namespace School.Web.Data.Repositories
{
    public class TeacherRepository : GenericRepository<Teacher>, ITeacherRepository
    {
        ...
        public async Task<bool> ValidationEditAsync(int id, string identificationNumber, string taxNumber, string ssNumber, string nhsNumber,
           string telephone, string email)
        {
            if ((await _context.Set<Student>().AllAsync(e => e.Id != id)) || (await _context.Set<Teacher>().AllAsync(e => e.Id != id)))
            {
                if ((await _context.Set<Student>().AnyAsync(e => e.IdentificationNumber == identificationNumber)) || (await _context.Set<Teacher>().AnyAsync(e => e.IdentificationNumber == identificationNumber)))
                    return true;
